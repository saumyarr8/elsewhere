                ...
                a = function() {
                    var e, t, n, r = function(e) {
                            var t = void 0 === e ? {} : e,
                                ...
                                s = void 0 === i ? c : i;
                            h(l(r), "`name` must be a string"), this._name = r, this._deletedRulePlaceholder = "#" + r + "-deleted-rule____{}", h("boolean" === typeof s, "`optimizeForSpeed` must be a boolean"), this._optimizeForSpeed = s, this._serverSheet = void 0, this._tags = [], this._injected = !1, this._rulesCount = 0;
                    ...
                    return i.setOptimizeForSpeed = function(e) {
                        ...
                        if (h(l(e), "`insertRule` accepts only strings"), this._optimizeForSpeed) {
                            var n = this.getSheet();
                        ...
                        t && h(l(t), "makeStyleTag accepts only strings as second parameter");
            ...
            ! function() {
                var t = {
                        229: function(e) {
                            ...
                            function h() {
                                l && u && (l = !1, u.length ? c = u.concat(c) : a = -1, c.length && d())
                            }

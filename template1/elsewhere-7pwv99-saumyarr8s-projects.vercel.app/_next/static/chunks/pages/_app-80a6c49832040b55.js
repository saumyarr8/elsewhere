        ...
        2601: function(e, t, r) {
            ...
            var o = r(5893),
                ...
                l = function(e) {
                    var t = e.initialLocales,
                        r = e.children,
                        n = (0, u.useLocale)(),
                        i = (0, h.useState)(null !== t && void 0 !== t ? t : [{
                            name: "English",
                            short: "en"
                        }]),
                        s = i[0],
            ...
            function f(e) {
                ...
                return (0, o.jsxs)(o.Fragment, {
                    ...
                    }), (0, o.jsx)(u.NextIntlProvider, {
                        messages: null === r || void 0 === r ? void 0 : r.messages,
                        locale: null === r || void 0 === r ? void 0 : r.locale,
                        children: (0, o.jsx)(l, {
        ...
        833: function(e, t, r) {
                    ...
                    switch (s) {
                        ...
                        case "time":
                            ...
                            if (this.bumpIf(",")) {
                                ...
                                if (0 === (v = se(y.val)).length) return this.error(l.EXPECT_ARGUMENT_STYLE, K(this.clonePosition(), this.clonePosition()));
                                h = {
                                    style: v,
                            ...
                            if (h && te(null === h || void 0 === h ? void 0 : h.style, "::", 0)) {
                                ...
                                if ("number" === s) return (y = this.parseNumberSkeletonFromString(m, h.styleLocation)).err ? y : {
                                    val: {
                                        type: f.number,
                                        value: r,
                                        location: c,
                        ...
                        case "select":
                            ...
                            if (this.bumpSpace(), !this.bumpIf(",")) return this.error(l.EXPECT_SELECT_ARGUMENT_OPTIONS, K(b, (0, E.__assign)({}, b)));
                            this.bumpSpace();
                            ...
                            if ("select" !== s && "offset" === _.value) {
                                ...
                                this.bumpSpace(), _ = this.parseIdentifierIfPossible(), d = y.val
                            }
            ...
            function pe(e) {
                e.forEach((function(e) {
                    if (delete e.location, y(e) || T(e))
                        for (var t in e.options) delete e.options[t].location, pe(e.options[t].value);
                    else b(e) && B(e.style) || (_(e) || d(e)) && S(e.style) ? delete e.style.location : A(e) && pe(e.children)
                }))
            }
            ...
            function _e(e, t) {
                return be(e, this, 1 === e.length ? ge : ve, t.cache.create(), t.serializer)
            }
            var de = function() {
            ...
            var Te, He = {
                ...
                Ae = {
                    variadic: function(e, t) {
                        return be(e, this, ve, t.cache.create(), t.serializer)
                    },
                    monadic: function(e, t) {
                        return be(e, this, ge, t.cache.create(), t.serializer)
                    }
                };
            ! function(e) {
            ...
            function Re(e, t, r, n, i, o, s) {
                ...
                for (var a = [], h = 0, u = e; h < u.length; h++) {
                    ...
                    if (g(c)) a.push({
                        ...
                        var f = i[l];
                        if (v(c)) f && "string" !== typeof f && "number" !== typeof f || (f = "string" === typeof f || "number" === typeof f ? String(f) : ""), a.push({
            ...
            function je(e) {
                ...
                function E(e, i, l) {
                    ...
                    try {
                        ...
                        return p(e, c.MISSING_MESSAGE, y.message)
                    }
                    var v, b = [s, u, e, String(E)].filter((function(e) {
                        return null != e
                    })).join(".");
                    if (null != a && a.has(b)) v = a.get(b);
                    else {
                        ...
                        try {
                            ...
                            return p(e, c.INVALID_MESSAGE, y.message)
                        }
                        null == a || a.set(b, v)
                    }
                    try {
                        var d = v.format(function(e) {
                        ...
                        if (null == d) throw new Error(void 0);
                        return (0, Ge.isValidElement)(d) || Array.isArray(d) || "string" === typeof d ? d : String(d)
                    } catch (y) {
                        return p(e, c.FORMATTING_ERROR, y.message)
                    }
                }
